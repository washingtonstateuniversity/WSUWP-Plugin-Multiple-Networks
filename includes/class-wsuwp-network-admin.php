...
class WSUWP_Network_Admin {

	/**
	 * @var WSUWP_Network_Admin
	 */
	...
	private $global_network_options = array(
		...
		'upload_filetypes' => 'jpg jpeg png gif mp3 webp oga ogg ogv webm mp4 pdf ai psd eps doc ppt xls csv key numbers pages dmg zip txt mat vtt pub sav mobi epub nb fp5 fp7 fmp12 ics dwg',
		'add_new_users' => 1,
	 ...
	 * @since 1.6.0
	 *
	 * @return \WSUWP_Network_Admin
	 */
	public static function get_instance() {
		if ( ! isset( self::$instance ) ) {
			self::$instance = new WSUWP_Network_Admin();
